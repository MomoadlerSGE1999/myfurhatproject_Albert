...
class WelcherPlatzRaum : Intent() {
    override fun getExamples(lang: furhatos.util.Language): List<String> {
        return listOf(
            ...
            "Was hat er gesagt", "Welchen Raum", "Welchen Platz", "Wohin", "Wohin muss ich", "Wohin muss ich nochmal", "Was meintest du", "Wohin", "Wo nochmal", "Wohin nochmal", "Welcher Platz nochmal"
        )
    }
}